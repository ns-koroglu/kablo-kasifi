...
extension KKStrings {
    static let russian = KKStrings(
        ...
        lastScanJustNow: "просканировано только что",
        lastScanAgo: "просканировано %@ назад",
        displaysEmpty: "Внешних дисплеев нет. Подключите кабель — и я скажу, в каком разрешении он работает.",
        notifyOnConnect: "Уведомлять при подключении устройства",
        notifConnected: "%@ подключено",
        notifDisconnected: "Устройство отключено",
