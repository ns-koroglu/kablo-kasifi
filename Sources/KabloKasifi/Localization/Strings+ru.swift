...
extension KKStrings {
    static let russian = KKStrings(
        ...
        usbDeviceCountOne: "1 USB-устройство",
        displayCount: "%d дисплеев",
        displayCountOne: "1 дисплей",
        ...
        linkSpeedUnknown: "Скорость соединения прочитать не удалось, поэтому я не виню ни кабель, ни хаб, ни устройство.",
        usbVersionUnknown: "версия USB неизвестна",
