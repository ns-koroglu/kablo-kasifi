...
extension KKStrings {
    static let french = KKStrings(
        ...
        lastScanJustNow: "analysé à l'instant",
        lastScanAgo: "analysé il y a %@",
        displaysEmpty: "Aucun écran externe. Branche un câble d'écran et je te dirai à quelle résolution il fonctionne.",
        notifyOnConnect: "Prévenir quand un périphérique est branché",
        notifConnected: "%@ connecté",
        notifDisconnected: "Périphérique retiré",
