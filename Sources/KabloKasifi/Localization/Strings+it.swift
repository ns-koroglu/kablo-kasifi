...
extension KKStrings {
    static let italian = KKStrings(
        ...
        copyReport: "Copia il report",
        copiedToClipboard: "Copiato negli appunti",
        lastScanJustNow: "analizzato adesso",
        lastScanAgo: "analizzato %@ fa",
        displaysEmpty: "Nessun display esterno. Collega un cavo video e ti dirò a quale risoluzione lavora.",
        notifyOnConnect: "Avvisa quando collego un dispositivo",
        notifConnected: "%@ collegato",
        notifDisconnected: "Dispositivo rimosso",
