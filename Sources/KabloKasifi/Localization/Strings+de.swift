...
extension KKStrings {
    static let german = KKStrings(
        ...
        lastScanJustNow: "gerade eben gescannt",
        lastScanAgo: "vor %@ gescannt",
        displaysEmpty: "Kein externes Display. Schließ ein Displaykabel an und ich sage dir, mit welcher Auflösung es läuft.",
        notifyOnConnect: "Benachrichtigen, wenn ein Gerät angeschlossen wird",
        notifConnected: "%@ verbunden",
        notifDisconnected: "Gerät entfernt",
