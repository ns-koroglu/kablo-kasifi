...
extension KKStrings {
    static let portuguese = KKStrings(
        ...
        linkSpeedUnknown: "Não foi possível ler a velocidade do enlace, então não culpo o cabo, o hub nem o dispositivo.",
        usbVersionUnknown: "versão USB desconhecida",
