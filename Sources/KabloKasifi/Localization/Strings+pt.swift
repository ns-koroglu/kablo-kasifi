...
extension KKStrings {
    static let portuguese = KKStrings(
        ...
        lastScanJustNow: "analisado agora",
        lastScanAgo: "analisado há %@",
        displaysEmpty: "Sem tela externa. Conecte um cabo de vídeo e eu digo em que resolução ela funciona.",
        notifyOnConnect: "Avisar quando um dispositivo for conectado",
        notifConnected: "%@ conectado",
        notifDisconnected: "Dispositivo removido",
