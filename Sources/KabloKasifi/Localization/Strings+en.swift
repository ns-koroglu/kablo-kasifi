...
extension KKStrings {
    static let english = KKStrings(
        ...
        lastScanJustNow: "scanned just now",
        lastScanAgo: "scanned %@ ago",
        displaysEmpty: "No external display. Plug a display cable in and I'll tell you what resolution it runs at.",
        notifyOnConnect: "Notify when a device is plugged in",
        notifConnected: "%@ connected",
        notifDisconnected: "Device removed",
