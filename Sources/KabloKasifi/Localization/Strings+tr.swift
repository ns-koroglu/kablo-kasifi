...
extension KKStrings {
    static let turkish = KKStrings(
        ...
        lastScanJustNow: "az önce tarandı",
        lastScanAgo: "%@ önce tarandı",
        displaysEmpty: "Harici ekran yok. Bir ekran kablosu takarsan hangi çözünürlükte çalıştığını yazarım.",
        notifyOnConnect: "Aygıt takılınca bildir",
        notifConnected: "%@ bağlandı",
        notifDisconnected: "Aygıt çıkarıldı",
