...
extension KKStrings {
    static let spanish = KKStrings(
        ...
        lastScanJustNow: "analizado ahora mismo",
        lastScanAgo: "analizado hace %@",
        displaysEmpty: "Sin pantalla externa. Conecta un cable de pantalla y te diré a qué resolución funciona.",
        notifyOnConnect: "Avisar cuando se conecte un dispositivo",
        notifConnected: "%@ conectado",
        notifDisconnected: "Dispositivo retirado",
